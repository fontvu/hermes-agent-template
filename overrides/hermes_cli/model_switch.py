...
# be visible so users can pick any model they have access to. CommandCode
# (and its Anthropic-profile sibling) surface 50+ models via a single base
# URL; capping at the default 50 silently drops the tail (e.g. the Meta
# muse-spark-1.2* and xai/grok-* families), so they are uncapped too.
_UNCAPPED_PICKER_PROVIDERS: frozenset[str] = frozenset(
    {"opencode-zen", "opencode-go", "commandcode", "commandcode-anthropic"}
)
